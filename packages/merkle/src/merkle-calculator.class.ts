...
export class MerkleCalculator implements IMerkleCalculator
{
   ...
   public getTopoBlockOrder(director: IDirector<ITopoOrderBuilder>): BlockTopologicalOrder
   {
      const options = TopoOrderOptions.create(director);
      return new BlockTopologicalOrder(this, this.treeDescription, options);
   }

   public getBfsBlockOrder(director: IDirector<IBfsOrderBuilder>): Iterable<BlockMappedDigestLocator>
   {
   ...
   public getDfsBlockOrder(director: IDirector<IDfsOrderBuilder>): Iterable<BlockMappedDigestLocator>
   {
