...
// value or the other.
import { Extends, Intersects, StronglyExtends } from '@jchptf/objecttypes';
...
// $ExpectType false
export type ExtendTest016 = Extends<string | boolean, string>;

// $ExpectType true
export type ExtendTest017 = Extends<string, string | boolean>;
