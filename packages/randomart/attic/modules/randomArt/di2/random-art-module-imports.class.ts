...
import { DI_COMMON_TAGS, IContainerAccessStrategy,
   installerRequest, requiredImport } from '@jchptf/di-app-registry';
import { Chanel } from 'chanel';
import { Chan } from 'medium';
import Queue from 'co-priority-queue';

import { PaintToCanvasRequest, LifecycleStopMessage, AssignCanvasRequest } from '../messages';
