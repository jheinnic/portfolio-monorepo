...
import {
   BlockMappedDigestLocator, IBfsOrderBuilder, IMerkleCalculator, MERKLE_TYPES, MerkleCalculator,
...
export class RandomArtDiAdapterFactory
{
   ...
   public extendCallback(
     ...
     director?: IDirector<IMerkleTreeModuleOptionsBuilder>) => ContainerModuleCallBack
   {
