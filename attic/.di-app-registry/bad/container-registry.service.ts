...
import {
   ApplicationIdentifier, ApplicationLauncher, IContainerRegistry, InstallerRegistryClient,
   InstallerService, InstallerServiceIdentifier, NestedContainerIdentifier
} from '../interfaces/index';
import {DI_COMMON_TAGS, DI_TYPES} from '../di/index';
import {IContainerRegistryInternal} from '../interfaces/container-registry-internal.interface';
import {ContainerRegistryInstallerClient} from '../../bad/container-registry-installer-client.class';
...
import {INSTALLER_METHOD_KEY} from '../../dist/decorators/index';
import {InstallerMethod} from '../decorators/index';
